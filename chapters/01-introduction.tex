...
enumerates all possible states of a program and checks for satisfaction of a
given property.} The main use case for model checking is to verify some
...
data.\sidenote{For example when we subtract a value one from the group of values
$\{1,5,12\}$ the~resulting group is $\{0,4,11\}$.} Traditionally, a similar
...
The experimental evaluation of the work is summarized in the
