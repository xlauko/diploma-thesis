...
\add{ Why to do abstraction in preprocessing of divine }
...
The only similar research has been done in ... \add{ add citation and small
description }
...
representing a concrete state in abstract world. \add{ Add reference to section
2} Additionally we have to define
