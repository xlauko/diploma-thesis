...
lift_{T_1}(v_1) \times \dots \times lift_{T_n}(v_n).\]
...
that if the operation takes both abstract and concrete value (for example an
...
\add{ describe store, load and alloca to the appendis}
