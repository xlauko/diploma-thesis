...
\tikzset {
    component/.style={
        fill=white, draw, text centered,
        rounded corners=1pt, minimum height=3 em,
        minimum width=2.2 cm, text width=2 cm
    },
    bcomponent/.style={
        fill=white, draw, text centered, minimum height=3 em,
        minimum width=2.2 cm, text width=6 cm
    },
    outer/.style={
        draw=none
    },
...
\newcommand{\fixmargin}[1]{
    { \let\marginpar\oldmarginpar #1 }
}

\newcommand{\mytodo}[1]{
    \todo[inline, linecolor=red,backgroundcolor=red!25,bordercolor=red]
    { #1 }
}
